      ...
      <nav className="main-navbar">
        <ul className="nav-list">
          ...
          <li className="dropdown">
            ...
            <ul className="dropdown-menu">
              <li onClick={() => navigate("/complaintstatus")}>FORM M</li>
              <li onClick={() => navigate("/complaintstatus")}>FORM N</li>
            </ul>
          </li>
          ...
          <li className="dropdown" tabIndex="0">
            ...
            <ul className="dropdown-menu">
              ...
              <li className="contact-submenu" tabIndex="0">
          ...
          <li className="dropdown dropdown-right">
            ...
            <ul className="dropdown-menu">
              ...
              <li onClick={() => navigate("/department")}>DEPARTMENT LOGIN</li>
              <li onClick={() => navigate("/promoter")}>PROMOTOR LOGIN</li>
            </ul>
          </li>
